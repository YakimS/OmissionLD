...
%% ============= OUTPUT FILE NAME =============
OUTPUT_FILE = 'Config-DoubleOmission_iti-1200.mat';  % Set to false for auto datetime naming
...
% Trial parameters
exp_meta.N_TRIALS = 500;            % Total trials per condition (double(isi x iti) + single(iti))
exp_meta.BLOCKS_PER_CONDITION = 5;  % Number of blocks per condition
